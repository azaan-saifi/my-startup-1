    ...
    <div className="space-y-8">
        ...
        >
          <div className="relative overflow-hidden rounded-lg border border-zinc-800 bg-black/60 p-6 backdrop-blur-sm h-full">
            ...
            <div className="flex h-full flex-col justify-center">
              <h3 className="text-xl font-medium text-white">Pricing Best Practices</h3>
      ...
      <div className="relative overflow-hidden rounded-lg border border-zinc-800 bg-black/60 p-6 backdrop-blur-sm">
        ...
        <div className="mb-6">
          ...
          <p className="mt-1 text-sm text-zinc-400">Conversion rates by plan type</p>
        </div>
          ...
          <table className="w-full min-w-full border-collapse">
            <thead>
              <tr className="border-b border-zinc-800 text-left">
                <th className="pb-3 text-xs font-medium uppercase tracking-wider text-zinc-400">Plan</th>
                <th className="pb-3 text-xs font-medium uppercase tracking-wider text-zinc-400">Conversions</th>
                <th className="pb-3 text-xs font-medium uppercase tracking-wider text-zinc-400">Revenue Share</th>
                <th className="pb-3 text-xs font-medium uppercase tracking-wider text-zinc-400">Performance</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-zinc-800">
              {pricingData.map((plan, index) => (
                <tr key={index} className="group hover:bg-zinc-900/20">
                  <td className="py-4 text-sm font-medium text-white">{plan.plan}</td>
                  <td className="py-4 text-sm text-zinc-400">{plan.conversions}</td>
